...
{
    class ToBeContinuedScreen : MenuScreen
    {
        #region Class Variables
        SpriteFont gameFont;
        Texture2D toBeContinued;
        ...
        public override void LoadContent()
        {
            ...
            toBeContinued = content.Load<Texture2D>("ui/ToBeContinued");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(toBeContinued, fullscreen, new Color(TransitionAlpha, TransitionAlpha, TransitionAlpha) * alphaValueGO);
            spriteBatch.DrawString(gameFont, "To Be Continued...", new Vector2(width / 2 - "To Be Continued...".Length, height / 2), Color.White);
#if XBOX
